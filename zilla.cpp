 ...
 int choice;
    while(1){
    	...
    	switch(choice){
		 ...
		 cin>>prem;
		    if(prem==1){
		    	cout<<"shortjob premeptive"<<endl;
		    	show.shortestjobfirstpremptive(process);
			}
			if(prem==2){
				cout<<"Output is Written in a File"<<endl;
...
void CPU::shortestjobfirstpremptive(int process){
   ...
   myfile1<<"\n shortestjob premptive is yet to be completed:" << endl;
